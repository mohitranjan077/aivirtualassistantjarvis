	...
	if __name__ == '__main__':
	    ...
	    while True:
	        ...
	        if 'time' in query:
	            ...
	            speak("Thanks to <YOUR NAME>. further it is a secret")
	        elif 'word' in query:
